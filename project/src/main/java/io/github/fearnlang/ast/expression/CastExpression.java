...
public class CastExpression extends Expression {
    ...
    public void GenerateBytecode(MethodVisitor mv) {
        ...
        switch (target) {
            ...
            case STR:
                mv.visitMethodInsn(INVOKESTATIC, "io/github/fearnlang/runtime/FearnRuntime", "Obj2Str", "(Ljava/lang/Object;)Ljava/lang/String;", false);
                return;
            case BOOL:
                mv.visitMethodInsn(INVOKESTATIC, "io/github/fearnlang/runtime/FearnRuntime", "Obj2B", "(Ljava/lang/Object;)Ljava/lang/Boolean;", false);
                return;
        }
