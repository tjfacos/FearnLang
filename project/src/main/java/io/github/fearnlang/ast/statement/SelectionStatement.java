...
public class SelectionStatement extends Statement {
    ...
    public Statement if_branch;
    public Statement else_branch;

    public SelectionStatement(Expression cond, Statement if_body, Statement else_body) {
        condition = cond;
        if_branch = if_body;
    ...
    public void GenerateBytecode(MethodVisitor mv) {
        ...
        // Generate if branch (program falls through to this if expression evaluates to
        // true)
