package io.github.tjfacos.codegen;
...
import io.github.tjfacos.ast.Program;
import io.github.tjfacos.ast.function.Parameter;
...
import io.github.tjfacos.parser.ASTConstructor;
import io.github.tjfacos.parser.gen.*;
import io.github.tjfacos.semantics.table.*;
import io.github.tjfacos.util.FearnErrorListener;
    ...
    public SymbolTable GetStdLib(String id) {
        ...
        switch (id) {
            case "io":
                ...
                // function calls refer the the correct package io.github.tjfacos.and class
