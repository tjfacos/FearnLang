...
public class FearnGrammarParser extends Parser {
	...
	public static final int
		...
		T__45=46, T__46=47, INT_LIT=48, FLOAT_LIT=49, STR_LIT=50, BOOL_LIT=51, 
		IDENTIFIER=52, WS=53;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			null, null, null, null, null, null, null, null, null, null, null, null, 
			null, null, null, null, null, null, null, null, null, null, null, null, 
			"INT_LIT", "FLOAT_LIT", "STR_LIT", "BOOL_LIT", "IDENTIFIER", "WS"
		};
	}
	...
	public final FunctionContext function() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 8725726420050432L) != 0)) {
				{
				setState(81);
				_errHandler.sync(this);
				switch (_input.LA(1)) {
	...
	public final Compound_statementContext compound_statement() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 8725726419493376L) != 0)) {
				{
				{
				setState(132);
				statement();
	...
	public final Struct_initContext struct_init() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 8725726291296768L) != 0)) {
				{
				setState(215);
				argument_list();
				}
	...
	public final Assignment_operatorContext assignment_operator() throws RecognitionException {
		...
		try {
			...
			setState(326);
			_la = _input.LA(1);
			if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & 272678883819520L) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
